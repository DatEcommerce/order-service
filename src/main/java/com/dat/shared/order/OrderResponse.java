...
public class OrderResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5316066904384467637L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderResponse\",\"namespace\":\"com.dat.shared.order\",\"fields\":[{\"name\":\"orderId\",\"type\":\"string\"},{\"name\":\"userId\",\"type\":\"string\"},{\"name\":\"totalPrice\",\"type\":\"double\"}]}");
   ...
   */
  public static BinaryMessageEncoder<OrderResponse> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a OrderResponse instance decoded from the given buffer
   ...
   */
  public OrderResponse(java.lang.CharSequence orderId, java.lang.CharSequence userId, java.lang.Double totalPrice) {
   ...
   */
  public static com.dat.shared.order.OrderResponse.Builder newBuilder() {
    return new com.dat.shared.order.OrderResponse.Builder();
  }
   ...
   * @return A new OrderResponse RecordBuilder
   */
  public static com.dat.shared.order.OrderResponse.Builder newBuilder(com.dat.shared.order.OrderResponse.Builder other) {
    if (other == null) {
      return new com.dat.shared.order.OrderResponse.Builder();
    } else {
      return new com.dat.shared.order.OrderResponse.Builder(other);
    }
  }
   ...
   * @return A new OrderResponse RecordBuilder
   */
  public static com.dat.shared.order.OrderResponse.Builder newBuilder(com.dat.shared.order.OrderResponse other) {
    if (other == null) {
      return new com.dat.shared.order.OrderResponse.Builder();
    } else {
      return new com.dat.shared.order.OrderResponse.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderResponse>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.dat.shared.order.OrderResponse.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.dat.shared.order.OrderResponse other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dat.shared.order.OrderResponse.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dat.shared.order.OrderResponse.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dat.shared.order.OrderResponse.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dat.shared.order.OrderResponse.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dat.shared.order.OrderResponse.Builder setTotalPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dat.shared.order.OrderResponse.Builder clearTotalPrice() {
